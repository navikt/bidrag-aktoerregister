...
@RestController
@RequestMapping("/bidrag-aktorer-old")
@Unprotected
public class AktoerregisterControllerOld {

    private final HendelseService hendelseService;
    private final AktoerregisterServiceOld aktoerregisterService;

    @Autowired
    public AktoerregisterControllerOld(HendelseService hendelseService, AktoerregisterServiceOld aktoerregisterService) {
    ...
    public ResponseEntity<AktoerDTO> hentAktoerinformasjon(
    ...
    public ResponseEntity<List<HendelseDTO>> hentKontonummerHendelser(
        ...
        List<HendelseDTO> hendelser = hendelseService
