...
public class TSSJobListener {
  ...
  public void afterJob(JobExecution jobExecution) {
    ...
    if (updateTSSAktoererStep != null) {
      long nrTotalAktoerer = getLongFromExecutionContext(TSSBatchConfig.NR_TOTAL, updateTSSAktoererStep.getExecutionContext());
      long nrOfUpdatedAktoerer = getLongFromExecutionContext(TSSBatchConfig.NR_UPDATED, updateTSSAktoererStep.getExecutionContext());
