...
public interface HendelseJpaRepository extends JpaRepository<Hendelse, Integer> {
  ...
  /**
   * Retrieves a list of the latest Hendelse for each Aktoer where the sekvensnummer of the Hendelse is greater than the specified sekvensnummer and limited by the given pageable.
   * @param sekvensnummer
   * @param pageable
   * @return
   */
