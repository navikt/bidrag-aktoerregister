...
public class TSSAktoerProcessorTests {
  ...
  @Test
  public void TestAktoerFromTssUpdated() throws MQServiceException, TSSServiceException, AktoerNotFoundException {
  ...
  @Test
  public void TestAktoerFromTssNotUpdated() throws MQServiceException, TSSServiceException, AktoerNotFoundException {
    Aktoer aktoer = new Aktoer();
    aktoer.setAktoerId("1234");
    aktoer.setAktoerType(IdenttypeDTO.PERSONNUMMER.name());
  ...
  @Test
  public void TestAkterNotFound() throws MQServiceException, TSSServiceException, AktoerNotFoundException {
    Aktoer aktoer = new Aktoer();
    aktoer.setAktoerId("1234");
    aktoer.setAktoerType(IdenttypeDTO.PERSONNUMMER.name());
