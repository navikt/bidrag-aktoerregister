...
public class MapperTests {
  ...
  public void TestAktoerMapper() {
    ...
    aktoerIdDTO.setAktoerId("12345678901");
    ...
    kontonummerDTO.setNorskKontonr("123123123123");
    ...
    assertEquals(aktoer.getKontonummer().getNorskKontonr(), aktoerDTO.getKontonummer().getNorskKontonr());
    ...
    assertEquals(mappedAktoerDTO.getAdresse().getAdresselinje1(), aktoer.getAdresse().getAdresselinje1());
    ...
    assertEquals(mappedAktoerDTO.getKontonummer().getNorskKontonr(), aktoer.getKontonummer().getNorskKontonr());
  }
